...
== Changelog ==
= Version: 1.6.9 - Date: 2021-11-30 =

Post Grid
* Added: Title hover color in Post Grid addon
* Added: Slider image overlay option in Post Grid addon
* Added: Content box style option in Post Grid addon
* Fixed: Content alignment issue in Post Grid addon
* Added: Item margin, padding and border radius option in Post Grid addon
* Added: Gradient Color change option in Post Grid addon
* Fixed: Responsive issue in Post Grid addon



Post Carousel
* Added: Title hover color in Post Carousel addon
* Added: Meta icon color option in Post Carousel addon
* Added: Slider image overlay option in Post Carousel addon
* Added: Slider image resize option in Post Carousel addon
* Added: Slider image custom height option in Post Carousel addon
* Added: Content box style option in Post Carousel addon
* Added: Arrow position option in Post Carousel addon
* Fixed: Content alignment issue in Post Carousel addon
* Fixed: Responsive issue in Post Carousel addon



Post Slider
* Added: Title hover color in post slider addon
* Added: Meta icon color option in post slider addon
* Added: Slider image overlay option in post slider addon
* Added: Slider image resize option in post slider addon
* Added: Slider image custom height option in post slider addon
* Added: Content box style option in post slider addon
* Added: New Two Layout in post slider addon
* Added: Image dot option in layout four of the post slider addon
* Added: Vertical space option in arrow of the post slider addon
* Fixed: Content alignment issue in post slider addon
* Fixed: Responsive issue in post slider addon


Post Gird Tab
* Added: Gradient Color change option in post grid tab addon
* Added: Content show/hide and content limit opion in post grid tab addon
* Added: Content box style option in post grid tab addon
* Added: Group item margin, padding and border radius option in post grid tab addon
* Added: Title hover color in post grid tab addon
* Added: Meta icon color option in post grid tab addon
* Added: Close icon padding, border, broder-radius option in post grid tab addon
* Fixed: Content alignment issue in single post addon
* Fixed: Responsive issue in single post addon


Single Post addon
* Fixed: Category height in single post addon
* Fixed: Meta normal color, hover color and alignment issue in single post addon
* Fixed: Title alignment issue in single post addon
* Added: Meta icon color change option addon
* Added: Content position option for style one in single post addon
* Added: Title hover color in single post addon
* Added: Content box margin, padding and background color option in single post addon
----------------------------------------------------------------------------------------
