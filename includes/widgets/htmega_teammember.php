        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'condition' =>[
                        'htmega_team_style' => array('1','3','5','6','7','8','2'),
                    ],
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} .htmega-team .htmega-team-content,{{WRAPPER}} .htmega-team-style-2 .htmega-team-hover-action .htmega-hover-action' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'condition' =>[
                        'htmega_team_style!' => array( '4' ),
                    ],
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .htmega-team .htmega-team-content' => 'text-align: {{VALUE}};',
                    ],
                    'condition' =>[
                        'htmega_team_style!' => array( '4' ),
                    ],
    ...
    protected function render( $instance = [] ) {
        ...
        if( '8' == $settings['htmega_team_style'] ){
            if( 'two'== $settings['htmega_team_content_style'] ){
                $this->add_render_attribute( 'team_area_attr', 'class', 'htmega-st8-new htmega-team-style-7 htmega-team-style-'.$settings['htmega_team_style'] );
            } else {
                $this->add_render_attribute( 'team_area_attr', 'class', ' htmega-team-style-7 htmega-team-style-'.$settings['htmega_team_style'] );
            }
            ...
            if( 'two'== $settings['htmega_team_content_style'] ){
                $this->add_render_attribute( 'team_area_attr', 'class', 'htmega-st2-new htmega-team-style-'.$settings['htmega_team_style'] ); 
            } else {
