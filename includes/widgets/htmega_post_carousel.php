...
class HTMega_Elementor_Widget_Post_Carousel extends Widget_Base {
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'label' => __( 'Background', 'htmega-addons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .htmega-single-post-slide:hover .thumb a:after',
                    'separator' => 'after',
                    'condition'=>[
                        'post_carousel_style' =>'3', 
                    ]
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'htmega_post_carousel', 'class', 'post-carousel-wrapper htmega-postcarousel-layout-'.$settings['post_carousel_style'].' '. $settings['slider_arrow_postion_option']);
