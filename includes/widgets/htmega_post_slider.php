                ...
                $this->start_controls_tab(
                    ...
                    $this->add_group_control(
                        ...
                        [
                            ...
                            'label' => __( 'Background', 'htmega-addons' ),
                            'types' => [ 'classic', 'gradient' ],
                            'selector' => '{{WRAPPER}} .htmega-postslider-style-4.htmega-postslider-area ul.slick-dots li.slick-active:after,{{WRAPPER}} .htmega-postslider-style-4.htmega-postslider-area ul.slick-dots li:hover:after',
                        ]
                    );
                    $this->add_responsive_control(
